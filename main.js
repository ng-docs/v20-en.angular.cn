...
var PREVIEWS_COMPONENTS_MAP = {
  ...
  ["adev/src/content/examples/animations/src/app/hero-list-enter-leave-page.component.ts"]: /* @__PURE__ */ __name(() => import("./chunk-5GIQX7NN.js").then((c) => c.HeroListEnterLeavePageComponent), "adev/src/content/examples/animations/src/app/hero-list-enter-leave-page.component.ts"),
  ...
  ["adev/src/content/examples/accessibility/src/app/app.component.ts"]: /* @__PURE__ */ __name(() => import("./chunk-CD7UW4BS.js").then((c) => c.AppComponent), "adev/src/content/examples/accessibility/src/app/app.component.ts"),
  ...
  ["adev/src/content/examples/structural-directives/src/app/app.component.ts"]: /* @__PURE__ */ __name(() => import("./chunk-O44H2G7F.js").then((c) => c.AppComponent), "adev/src/content/examples/structural-directives/src/app/app.component.ts"),
  ...
  ["adev/src/content/examples/pipes/src/app/app.component.ts"]: /* @__PURE__ */ __name(() => import("./chunk-ZI6PKMW2.js").then((c) => c.AppComponent), "adev/src/content/examples/pipes/src/app/app.component.ts"),
  ...
  ["adev/src/content/examples/pipes/src/app/flying-heroes.component.ts_FlyingHeroesComponent"]: /* @__PURE__ */ __name(() => import("./chunk-245DWVEZ.js").then((c) => c.FlyingHeroesComponent), "adev/src/content/examples/pipes/src/app/flying-heroes.component.ts_FlyingHeroesComponent"),
  ["adev/src/content/examples/pipes/src/app/flying-heroes.component.ts_FlyingHeroesImpureComponent"]: /* @__PURE__ */ __name(() => import("./chunk-245DWVEZ.js").then((c) => c.FlyingHeroesImpureComponent), "adev/src/content/examples/pipes/src/app/flying-heroes.component.ts_FlyingHeroesImpureComponent"),
  ...
  ["adev/src/content/examples/pipes/src/app/precedence.component.ts"]: /* @__PURE__ */ __name(() => import("./chunk-2DLN2YM3.js").then((c) => c.PrecedenceComponent), "adev/src/content/examples/pipes/src/app/precedence.component.ts"),
...
var DOCS_ROUTES = mapNavigationItemsToRoutes(flatNavigationData(SUB_NAVIGATION_DATA.docs).filter((route) => !route.path?.startsWith(PAGE_PREFIX.TUTORIALS) && route.path !== PAGE_PREFIX.PLAYGROUND), __spreadValues({
  loadComponent: /* @__PURE__ */ __name(() => import("./chunk-J6IQKPD6.js"), "loadComponent"),
  data: {
...
var referencePageRoutes = mapNavigationItemsToRoutes(referenceNavigationItems.filter((r) => r.path === DEFAULT_PAGES.REFERENCE), __spreadValues({
  loadComponent: /* @__PURE__ */ __name(() => import("./chunk-YFQTRPNF.js"), "loadComponent"),
...
var updateGuidePageRoute = __spreadValues({
  ...
  loadComponent: /* @__PURE__ */ __name(() => import("./chunk-HDRLTOBT.js"), "loadComponent"),
  data: commonReferenceRouteData
...
var cliReferencePageRoutes = mapNavigationItemsToRoutes(referenceNavigationItems.filter((r) => r.path?.startsWith(`${PAGE_PREFIX.CLI}/`)), __spreadValues({
  loadComponent: /* @__PURE__ */ __name(() => import("./chunk-HSLWYOEW.js"), "loadComponent"),
  data: commonReferenceRouteData
...
var tutorialComponentRoutes = mapNavigationItemsToRoutes(tutorialsNavigationItems.filter((route) => route.path !== DEFAULT_PAGES.TUTORIALS), __spreadValues({
  loadComponent: /* @__PURE__ */ __name(() => import("./chunk-UGGHA5WZ.js"), "loadComponent"),
  data: __spreadValues({}, commonTutorialRouteData)
...
var FOOTER_ROUTES = mapNavigationItemsToRoutes(flatNavigationData(SUB_NAVIGATION_DATA.footer), __spreadValues({ loadComponent: /* @__PURE__ */ __name(() => import("./chunk-J6IQKPD6.js"), "loadComponent") }, false ? { \u0275entryName: "src/app/features/docs/docs.component.ts" } : {}));
...
var routes = [
  {
    ...
    children: [
      __spreadValues({
        path: "",
        loadComponent: /* @__PURE__ */ __name(() => import("./chunk-HNW45XVR.js"), "loadComponent"),
        data: { label: "Home" }
      ...
      __spreadValues({
        ...
        loadComponent: /* @__PURE__ */ __name(() => import("./chunk-JSDVIL5M.js"), "loadComponent"),
